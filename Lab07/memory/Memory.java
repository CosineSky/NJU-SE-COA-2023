...
public class Memory {
    ...
    private final String ZERO32 = "00000000000000000000000000000000";
    ...
    public void seg_load(int segIndex) {
        ...
        temp.base = ZERO32.toCharArray();
        temp.limit = "11111111111111111111".toCharArray();
        temp.validBit = true;
        temp.granularity = PAGE;
        if ( !PAGE ) {
            this.write(ZERO32, 1 << 20, disk.read(ZERO32, 1 << 20));
        }
    }
    ...
    public void page_load(int vPageNo) {
        // TODO
        int len = PAGE_SIZE_B;
        byte[] data = disk.read(Transformer.intToBinary(String.valueOf(vPageNo)).substring(12) + ZERO12, len);
        String pageFrame = "";
