package COA2023.Lab07.memory.cache;

import COA2023.Lab07.memory.Memory;
import COA2023.Lab07.util.Transformer;
import COA2023.Lab07.memory.cache.cacheReplacementStrategy.ReplacementStrategy;
    ...
    private int fetch(String pAddr) {
        ...
        if (lineInCache == -1) {
            if (tagBinaryLen == tagLen) { //全关联映射
                ...
                lineInCache = Integer.parseInt(pAddr.substring(tagBinaryLen, tagLen), 2);
            }
