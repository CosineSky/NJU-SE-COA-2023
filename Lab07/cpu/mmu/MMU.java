package COA2023.Lab07.cpu.mmu;

import COA2023.Lab07.cpu.alu.ALU;
import COA2023.Lab07.memory.Memory;
import COA2023.Lab07.memory.cache.Cache;
import COA2023.Lab07.memory.tlb.TLB;
import COA2023.Lab07.util.DataType;
import COA2023.Lab07.util.Transformer;
...
public class MMU {
    ...
    private final String ZERO4 = "0000";
    private final String ZERO12 = "000000000000";
    private final String ZERO16 = "0000000000000000";
    ...
    private String toRealLinearAddr(String logicAddr) {
        // TODO
        return ZERO12 + alu.add(new DataType(ZERO12 + logicAddr.substring(0, 16) + ZERO4), new DataType(ZERO16 + logicAddr.substring(32))).toString().substring(12);
    }
    ...
    private String toSegLinearAddr(String logicAddr) {
        // TODO
        return alu.add(new DataType(logicAddr.substring(16)), new DataType(new String(this.memory.getBaseOfSegDes(getSegIndex(logicAddr))))).toString();
    }
    ...
    private String toPagePhysicalAddr(String linearAddr) {
        ...
        int vPageNO = Integer.parseInt(Transformer.binaryToInt(ZERO12 + linearAddr.substring(0, 20)));
        String phyPageNO = TLB.isAvailable ? new String(tlb.getFrameOfPage(vPageNO)) : String.valueOf(memory.getFrameOfPage(vPageNO));
