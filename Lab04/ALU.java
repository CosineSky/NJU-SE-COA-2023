...
import COA2023.Lab01;
import COA2023.Lab04.util.DataType;
import COA2023.Lab04.util.BinaryIntegers;
import COA2023.Lab04.util.DataType;
...
//        }
    ...
    public static void main(String[] args) {
        ALU alu = new ALU();
//        DataType dt1 = new DataType(Lab01.intToBinary("3"));
//        DataType dt2 = new DataType(Lab01.intToBinary("1"));
        DataType dt1 = new DataType("01000000000000000000000000000011");
        DataType dt2 = new DataType("00000000000000000000000000000001");

//        System.out.println("Result: " + mul(dt1, dt2));
        System.out.println("Quotient: " + Lab01.binaryToInt(alu.div(dt1, dt2).toString()));
        System.out.println("Remainder: " + Lab01.binaryToInt(alu.remainderReg.toString()));
    }
